...
$(function () {
        ...
        success: function (response) {
            if (response.value) {
                ...
                if(camera){
                    ...
                    $('#idBtnDatHang').attr("href", "/dat-hang-ruou?camId="+camId);
                    $('#idReplayHistory').attr("href", "/camera?camId="+camId);
                }       
            }
        },
        error: function () {
            console.log("Can not load detail camera")
        }
    });
    ...
    $.ajax({
        ...
        error: function () {
            console.log("Can not load list related video");
